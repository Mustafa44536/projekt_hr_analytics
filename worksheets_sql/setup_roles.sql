...
GRANT ROLE ETL_DLT_ROLE TO ROLE TRANSFORM_DBT_ROLE;

GRANT USAGE, CREATE TABLE, CREATE VIEW ON SCHEMA HR_ANALYTICS.WAREHOUSE TO ROLE TRANSFORM_DBT_ROLE;

GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA HR_ANALYTICS.WAREHOUSE TO ROLE TRANSFORM_DBT_ROLE;

GRANT SELECT, INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA HR_ANALYTICS.WAREHOUSE TO ROLE TRANSFORM_DBT_ROLE;
...
GRANT SELECT ON ALL VIEWS IN SCHEMA HR_ANALYTICS.MART TO ROLE BI_ROLE;

GRANT SELECT ON FUTURE TABLES IN SCHEMA HR_ANALYTICS.MART TO ROLE BI_ROLE;

GRANT SELECT ON FUTURE VIEWS IN SCHEMA HR_ANALYTICS.MART TO ROLE BI_ROLE;

SHOW GRANTS ON SCHEMA HR_ANALYTICS.MART;

SELECT * FROM HR_ANALYTICS.MART.MART_ADMINISTRATION_EKONOMI_JURIDIK;
